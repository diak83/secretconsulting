...
const generateProfessionalReport = (user: any, saju: any, menuId: number) => {
  ...
  } else if (menuId === 2) { // 2. 효과적인 학습방법 정밀 컨설팅
  ...
  } else if (menuId === 3) { // 3. 추천 학습 아이템(풍수) 정밀 컨설팅
  ...
  } else if (menuId === 5) { // 5. 미래 추천직업 정밀 컨설팅
