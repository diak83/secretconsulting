...
const DM_MATRIX: Record<string, any> = {
  甲: { name: "갑목(甲木)", nature: "하늘을 뚫고 오르는 거대한 소나무", core: "타인의 통제나 간섭을 극도로 혐오하며, 본인이 납득한 목표를 향해 불도저처럼 밀어붙이는 개척자적 자아를 세팅받았습니다.", talk: "직접적인 명령이나 통제 언어에 전두엽이 가장 먼저 닫히며 반발심이 폭발하는 주파수를 지녔습니다." },
  乙: { name: "을목(乙木)", nature: "척박한 바위도 뚫고 번식하는 끈질긴 넝쿨", core: "주변 환경과 공기에 완벽하게 동기화되는 스펀지 같은 흡수력을 지녔으며, 강압적인 압박보다 유연한 분위기 속에서 천재성이 폭발합니다.", talk: "자신의 감정을 인정받지 못한다고 느낄 때 귀를 닫아버리며, 따뜻한 교감 주파수에 가장 긍정적으로 반응합니다." },
  丙: { name: "병화(丙火)", nature: "세상을 환하게 비추는 눈부신 태양", core: "타인의 시선과 칭찬을 도파민 삼아 폭발적으로 성장하며, 스스로 주도하여 남에게 설명하고 과시할 때 지적 능력이 극대화됩니다.", talk: "본인의 자존심을 긁거나 남과 비교하는 순간 이성적 판단을 멈추고 감정의 불덩이로 변모하는 레이더를 가졌습니다." },
  丁: { name: "정화(丁火)", nature: "어둠을 파고드는 예리한 심야의 모닥불", core: "한 번 꽂힌 대상에 대해 끝을 보는 집요함과 완벽주의를 타고났으며, 남들이 방해하지 않는 고요한 시공간에서 잠재력이 만개합니다.", talk: "표면적으로는 순응하는 척하지만 내면에 논리적 의구심을 날카롭게 품고 있어, 강압적 명분에는 결코 굴복하지 않습니다." },
  戊: { name: "무토(戊土)", nature: "흔들림 없이 만물을 품어내는 거대한 태산", core: "얕은 잔재주를 혐오하며 우직하고 묵묵하게 본인만의 루틴을 쌓아 올릴 때 누구도 넘볼 수 없는 거대한 성취를 쟁취하는 그릇입니다.", talk: "급격한 변화나 잦은 잔소리에 피로감을 느끼며, 한 번 믿음을 준 존재의 묵직한 조언만을 선별하여 흡수합니다." },
  己: { name: "기토(己土)", nature: "모든 지식을 배양해 내는 비옥한 평야", core: "비상한 기억력과 디테일을 잡아내는 섬세함을 타고났으나, 틀리는 것에 대한 두려움이 커서 완벽한 안전망이 주어져야 실력을 발휘합니다.", talk: "본인의 실수를 예리하게 찌르는 팩트 폭격에 심하게 상처받으며, 다정하고 포용적인 쿠션 언어를 필요로 합니다." },
  庚: { name: "경금(庚金)", nature: "강인한 무쇠", strength: "결단력, 실행력", core: "확실한 보상과 즉각적인 결과물이 주어질 때 눈빛이 돌변하는 실전파 경주마로, 추상적인 목표보다 현실적인 타겟을 부숴나가는 데 능합니다.", talk: "감정적인 호소나 비논리적인 잔소리를 완벽한 소음으로 차단하며, 간결하고 명확한 목표 지향적 화법에만 반응합니다." },
  辛: { name: "신금(辛金)", nature: "작은 흠집도 용납하지 않는 예리한 보석", core: "고도의 예민함과 날카로운 직관력으로 지식의 빈틈을 핀셋처럼 짚어내며, 획일적인 교육을 거부하는 초정밀 완벽주의자입니다.", talk: "가장 미세한 어조의 변화나 자신을 무시하는 듯한 뉘앙스를 0.1초 만에 감지하고 마음의 문을 차갑게 닫아버립니다." },
  壬: { name: "임수(壬水)", nature: "거대한 흐름을 관망하는 깊고 넓은 바다", core: "단순 암기를 경멸하고 지식의 근원적인 원리와 거시적인 빅픽처를 이해해야만 비로소 시냅스가 연결되는 심연의 설계자입니다.", talk: "본인의 깊은 생각을 얕은 잣대로 평가받는 것을 혐오하며, 독립적인 사고 시간을 보장해 주는 대화법을 갈망합니다." },
  癸: { name: "계수(癸水)", nature: "어디로든 스며들어 틀을 깨는 촉촉한 봄비", core: "남들이 생각지 못한 기발한 패턴으로 정답을 유추해 내는 직관적 천재성이 다분하며, 가만히 앉아 듣기만 하는 환경에서 뇌가 굳어버립니다.", talk: "규칙을 강요하는 억압적 언어에 가장 먼저 질식하며, 상상력을 존중해 주는 부드러운 유도 질문에 천재성을 드러냅니다." }
};
